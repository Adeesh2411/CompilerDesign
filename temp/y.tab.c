...
#line 2005 "y.tab.c"
  ...
  case 24:
#line 369 "program_test.y"
          { }
#line 2011 "y.tab.c"
    break;

  case 28:
#line 375 "program_test.y"
        {
...
#line 2450 "y.tab.c"
  ...
  case 87:
#line 633 "program_test.y"
                {strcpy(tempArr1, (yyvsp[-2].txt));strcpy(tempArr2, (yyvsp[-1].txt));strcpy(tempArr3, (yyvsp[0].txt));}
#line 2456 "y.tab.c"
    break;

  case 88:
#line 634 "program_test.y"
                   {strcpy(tempArr1, (yyvsp[-2].txt));strcpy(tempArr2, (yyvsp[-1].txt));strcpy(tempArr3, (yyvsp[0].txt));}
#line 2462 "y.tab.c"
    break;

  case 89:
#line 635 "program_test.y"
...
#line 2485 "y.tab.c"
  ...
  case 92:
#line 648 "program_test.y"
                 {strcpy(tempArr1, (yyvsp[-2].txt));strcpy(tempArr2, (yyvsp[-1].txt));strcpy(tempArr3, (yyvsp[0].txt));}
#line 2491 "y.tab.c"
    break;

  case 93:
#line 649 "program_test.y"
               {strcpy(tempArr1, (yyvsp[-2].txt));strcpy(tempArr2, (yyvsp[-1].txt));strcpy(tempArr3, (yyvsp[0].txt));}
#line 2497 "y.tab.c"
    break;
